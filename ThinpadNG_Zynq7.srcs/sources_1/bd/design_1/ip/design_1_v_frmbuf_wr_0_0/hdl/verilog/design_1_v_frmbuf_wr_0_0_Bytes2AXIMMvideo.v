...
reg   [0:0] ap_reg_pp0_iter1_exitcond_i_reg_385;
reg    dstImg_V_blk_n_B;
wire    ap_CS_fsm_state110;
reg    dstImg_V_offset_blk_n;
reg    HwReg_height_cast5_loc_blk_n;
reg    tmp_8_loc_blk_n;
reg   [13:0] x_i_i_i_reg_224;
wire   [13:0] loopWidth_cast_i_i_c_fu_245_p4;
reg   [13:0] loopWidth_cast_i_i_c_reg_341;
reg    ap_block_state1;
wire   [16:0] tmp_13_cast_i_i_i_fu_255_p1;
reg   [16:0] tmp_13_cast_i_i_i_reg_346;
wire   [28:0] tmp_15_cast_i_i_i_fu_269_p1;
wire   [31:0] tmp_3_i_fu_273_p1;
reg   [31:0] tmp_3_i_reg_356;
wire   [29:0] sext_cast_i_fu_287_p1;
reg   [29:0] sext_cast_i_reg_361;
wire   [15:0] y_fu_300_p2;
reg   [15:0] y_reg_369;
wire    ap_CS_fsm_state2;
wire   [29:0] sum_i_fu_310_p2;
reg   [29:0] sum_i_reg_374;
wire   [0:0] exitcond_i_i_i_fu_295_p2;
...
wire   [13:0] x_fu_330_p2;
reg    ap_enable_reg_pp0_iter0;
reg   [63:0] tmp_V_reg_394;
wire   [28:0] yoffset_fu_336_p2;
reg   [28:0] yoffset_reg_399;
wire    ap_CS_fsm_state7;
reg    ap_block_pp0_stage0_subdone;
reg    ap_condition_pp0_exit_iter0_state4;
reg   [28:0] yoffset_i_i_i_reg_201;
reg   [15:0] y_i_i_i_reg_213;
wire   [63:0] sum_cast_i_fu_315_p1;
reg    ap_reg_ioackin_m_axi_dstImg_V_AWREADY;
reg    ap_reg_ioackin_m_axi_dstImg_V_WREADY;
reg    ap_block_pp0_stage0_01001;
wire   [16:0] tmp_cast_i_i_i_fu_235_p1;
wire   [16:0] tmp_i_i_i_fu_239_p2;
wire   [12:0] tmp_15_i_i_i_fu_259_p4;
wire   [28:0] tmp_fu_277_p4;
wire   [16:0] y_cast_i_i_i_fu_291_p1;
wire   [29:0] tmp_2_cast_i_fu_306_p1;
reg   [107:0] ap_NS_fsm;
reg    ap_idle_pp0;
wire    ap_enable_pp0;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((1'b1 == ap_continue)) begin
            ap_done_reg <= 1'b0;
        end else if (((exitcond_i_i_i_fu_295_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b1 == ap_enable_reg_pp0_iter2) & (1'd0 == ap_reg_pp0_iter1_exitcond_i_reg_385))) begin
...
always @ (posedge ap_clk) begin
    if (((ap_block_pp0_stage0_11001 == 1'b0) & (1'b1 == ap_enable_reg_pp0_iter0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'd0 == exitcond_i_fu_325_p2))) begin
        x_i_i_i_reg_224 <= x_fu_330_p2;
    end else if (((ap_sig_ioackin_m_axi_dstImg_V_AWREADY == 1'b1) & (1'b1 == ap_CS_fsm_state3))) begin
        x_i_i_i_reg_224 <= 14'd0;
    end
end
...
always @ (posedge ap_clk) begin
    if ((~((1'b0 == tmp_8_loc_empty_n) | (1'b0 == HwReg_height_cast5_loc_empty_n) | (1'b0 == dstImg_V_offset_empty_n) | (1'b0 == ap_start) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        loopWidth_cast_i_i_c_reg_341 <= {{tmp_i_i_i_fu_239_p2[16:3]}};
        sext_cast_i_reg_361[28 : 0] <= sext_cast_i_fu_287_p1[28 : 0];
        tmp_13_cast_i_i_i_reg_346[10 : 0] <= tmp_13_cast_i_i_i_fu_255_p1[10 : 0];
        tmp_3_i_reg_356[13 : 0] <= tmp_3_i_fu_273_p1[13 : 0];
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state2) & (1'd0 == exitcond_i_i_i_fu_295_p2))) begin
        sum_i_reg_374 <= sum_i_fu_310_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((ap_block_pp0_stage0_11001 == 1'b0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'd0 == exitcond_i_reg_385))) begin
...
always @ (*) begin
    if ((exitcond_i_fu_325_p2 == 1'd1)) begin
...
always @ (*) begin
    if (((exitcond_i_i_i_fu_295_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if (((ap_block_pp0_stage0 == 1'b0) & (1'b1 == ap_enable_reg_pp0_iter1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'd0 == exitcond_i_reg_385))) begin
...
always @ (*) begin
    if (((ap_block_pp0_stage0_11001 == 1'b0) & (1'b1 == ap_enable_reg_pp0_iter1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'd0 == exitcond_i_reg_385))) begin
...
always @ (*) begin
    if (((ap_block_pp0_stage0 == 1'b0) & (1'b1 == ap_enable_reg_pp0_iter2) & (1'd0 == ap_reg_pp0_iter1_exitcond_i_reg_385))) begin
...
always @ (*) begin
    if (((ap_block_pp0_stage0_01001 == 1'b0) & (1'b0 == ap_reg_ioackin_m_axi_dstImg_V_WREADY) & (1'b1 == ap_enable_reg_pp0_iter2) & (1'd0 == ap_reg_pp0_iter1_exitcond_i_reg_385))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((ap_block_pp0_stage0_subdone == 1'b0) & (exitcond_i_fu_325_p2 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b0) & (1'b1 == ap_enable_reg_pp0_iter0)) & ~((ap_block_pp0_stage0_subdone == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b0) & (1'b1 == ap_enable_reg_pp0_iter2)))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if ((((ap_block_pp0_stage0_subdone == 1'b0) & (exitcond_i_fu_325_p2 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b0) & (1'b1 == ap_enable_reg_pp0_iter0)) | ((ap_block_pp0_stage0_subdone == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b0) & (1'b1 == ap_enable_reg_pp0_iter2)))) begin
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((1'b0 == bytes_plane0_V_V_empty_n) & (1'b1 == ap_enable_reg_pp0_iter1) & (1'd0 == exitcond_i_reg_385));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((1'b1 == ap_enable_reg_pp0_iter2) & (1'b1 == ap_block_state6_io)) | ((1'b0 == bytes_plane0_V_V_empty_n) & (1'b1 == ap_enable_reg_pp0_iter1) & (1'd0 == exitcond_i_reg_385)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((1'b1 == ap_enable_reg_pp0_iter2) & (1'b1 == ap_block_state6_io)) | ((1'b0 == bytes_plane0_V_V_empty_n) & (1'b1 == ap_enable_reg_pp0_iter1) & (1'd0 == exitcond_i_reg_385)));
end
...
always @ (*) begin
    ap_block_state5_pp0_stage0_iter1 = ((1'b0 == bytes_plane0_V_V_empty_n) & (1'd0 == exitcond_i_reg_385));
end

always @ (*) begin
    ap_block_state6_io = ((1'b0 == ap_sig_ioackin_m_axi_dstImg_V_WREADY) & (1'd0 == ap_reg_pp0_iter1_exitcond_i_reg_385));
end
...
assign exitcond_i_fu_325_p2 = ((x_i_i_i_reg_224 == loopWidth_cast_i_i_c_reg_341) ? 1'b1 : 1'b0);

assign exitcond_i_i_i_fu_295_p2 = ((y_cast_i_i_i_fu_291_p1 == tmp_13_cast_i_i_i_reg_346) ? 1'b1 : 1'b0);

assign loopWidth_cast_i_i_c_fu_245_p4 = {{tmp_i_i_i_fu_239_p2[16:3]}};
...
assign m_axi_dstImg_V_AWADDR = sum_cast_i_fu_315_p1;
...
assign m_axi_dstImg_V_AWLEN = tmp_3_i_reg_356;
...
assign m_axi_dstImg_V_WDATA = tmp_V_reg_394;
...
assign sext_cast_i_fu_287_p1 = tmp_fu_277_p4;

assign sum_cast_i_fu_315_p1 = sum_i_reg_374;

assign sum_i_fu_310_p2 = (sext_cast_i_reg_361 + tmp_2_cast_i_fu_306_p1);

assign tmp_13_cast_i_i_i_fu_255_p1 = HwReg_height_cast5_loc_dout;

assign tmp_15_cast_i_i_i_fu_269_p1 = tmp_15_i_i_i_fu_259_p4;

assign tmp_15_i_i_i_fu_259_p4 = {{StrideInBytes[15:3]}};

assign tmp_2_cast_i_fu_306_p1 = yoffset_i_i_i_reg_201;

assign tmp_3_i_fu_273_p1 = loopWidth_cast_i_i_c_fu_245_p4;

assign tmp_cast_i_i_i_fu_235_p1 = tmp_8_loc_dout;

assign tmp_fu_277_p4 = {{dstImg_V_offset_dout[31:3]}};

assign tmp_i_i_i_fu_239_p2 = (tmp_cast_i_i_i_fu_235_p1 + 17'd7);

assign x_fu_330_p2 = (x_i_i_i_reg_224 + 14'd1);

assign y_cast_i_i_i_fu_291_p1 = y_i_i_i_reg_213;

assign y_fu_300_p2 = (y_i_i_i_reg_213 + 16'd1);

assign yoffset_fu_336_p2 = (tmp_15_cast_i_i_i_fu_269_p1 + yoffset_i_i_i_reg_201);

always @ (posedge ap_clk) begin
    tmp_13_cast_i_i_i_reg_346[16:11] <= 6'b000000;
    tmp_3_i_reg_356[31:14] <= 18'b000000000000000000;
    sext_cast_i_reg_361[29] <= 1'b0;
end

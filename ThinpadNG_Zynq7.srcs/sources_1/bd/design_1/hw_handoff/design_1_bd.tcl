...
proc create_root_design { parentCell } {
  ...
  # Create instance: zynq_dna_build_time, and set properties
  set zynq_dna_build_time [ create_bd_cell -type ip -vlnv user.org:user:zynq_dna_usr_data:1.1 zynq_dna_build_time ]
...
set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets S_AXIS_0_1]
  ...
  connect_bd_intf_net -intf_net axi_apb_bridge_0_APB_M [get_bd_intf_pins axi_apb_bridge_0/APB_M] [get_bd_intf_pins zynq_dna_build_time/S_APB]
  connect_bd_intf_net -intf_net axi_apb_bridge_0_APB_M2 [get_bd_intf_pins axi_apb_bridge_0/APB_M2] [get_bd_intf_pins parallel_apb_adapter_0/APB]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M09_AXI [get_bd_intf_pins axi_apb_bridge_0/AXI4_LITE] [get_bd_intf_pins axi_interconnect_0/M09_AXI]
  set_property SIM_ATTRIBUTE.MARK_SIM "true" [get_bd_intf_nets /axi_interconnect_0_M09_AXI]
...
set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets s_aresetn_0_1]
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0x41230000 [get_bd_addr_spaces ps7_0/Data] [get_bd_addr_segs parallel_apb_adapter_0/APB/Ctrl] SEG_parallel_apb_adapter_0_Ctrl
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0x41231000 [get_bd_addr_spaces ps7_0/Data] [get_bd_addr_segs zynq_dna_build_time/S_APB/reg] SEG_zynq_dna_build_time_reg

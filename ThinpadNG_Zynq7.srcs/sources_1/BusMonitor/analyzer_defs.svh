...
modport src(output data, addr, be_n, oe_n, next_be_n, next_oe_n, next_we_n, next_ce_n, ce_before, oe_before, be_before, we_before, data_before, addr_before);
modport sink(input data, addr, be_n, oe_n, next_be_n, next_oe_n, next_we_n, next_ce_n, ce_before, oe_before, be_before, we_before, data_before, addr_before);
